...
//D3 and ES6    
   ...
   //ES6   (selection, ...classNames)
  //classNames.forEach(name => selection.classList.toggle(name));
  ...
  let getRandomValues = (array, numOfVals=wordCount) => shuffle(array.slice(0,numOfVals));
